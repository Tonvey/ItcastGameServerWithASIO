...
void GameProtocol::SendOut(UserData &ud)
{
    GG_LOG_DEBUG("SendOut");
    std::string *outData = this->response2raw(ud);
    //auto ss = mSession.lock();
    //if(ss)
    //{
    mSession->do_write(*outData);
        //}
        //else
        //{
        //    GG_LOG_DEBUG("Error in lock session");
        //}
}
...
//std::shared_ptr<Session> GameProtocol::GetMsgSender(BytesMsg & _oBytes)
//{
//    auto ptr = this->mSession.lock();
//    if(!ptr)
//    {
//        cerr<<"ajdsljadslfjk"<<endl;
//    }
//	return ptr;
//}
